...
export function getProjectStakeSource({
  projectId,
  _stakingSeed,
  ...
  return helios`
    staking project_stake

    import { Datum as ProjectDetailDatum } from project_detail_types
    import {
      Datum as ProjectDatum,
      Redeemer as ProjectRedeemer
    } from project_validator_types
    import { Datum as PParamsDatum } from protocol_params_types
    import { Redeemer as ProjectDetailRedeemer } from project_detail_types
    import { Redeemer as ProjectScriptRedeemer } from project_script_types
