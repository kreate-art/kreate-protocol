...
export function getProjectDetailValidatorSource({
  projectsAuthTokenMPH,
  protocolNftMPH,
}: ProjectDetailParams) {
  return helios`
    spending project_detail_validator

    import { Datum, Redeemer } from project_detail_types
