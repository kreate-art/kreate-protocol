...
export function getProjectATPolicySource(protocolNftMPH: string) {
  return helios`
    minting project_at_policy

    import { Redeemer } from project_at_types
    import { Redeemer as ProjectRedeemer } from project_validator_types
    import { Datum as ProjectDetailDatum } from project_detail_types
    ...
    import { Datum as DedicatedTreasuryDatum } from dedicated_treasury_types
