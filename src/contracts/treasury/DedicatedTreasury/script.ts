...
export function getDedicatedTreasuryValidatorSource({
  projectsAuthTokenMPH,
  protocolNftMPH,
}: DedicatedTreasuryParams) {
  return helios`
    spending dedicated_treasury_validator

    import { Datum, Redeemer } from dedicated_treasury_types
    ...
    import { Datum as SharedTreasuryDatum } from shared_treasury_types
