...
export default helios`
  ...
  const SHARED_TREASURY_AT_TOKEN_NAME: ByteArray =
    #${TREASURY_AT_TOKEN_NAMES.SHARED}

  const DEDICATED_TREASURY_AT_TOKEN_NAME: ByteArray =
    #${TREASURY_AT_TOKEN_NAMES.DEDICATED}
